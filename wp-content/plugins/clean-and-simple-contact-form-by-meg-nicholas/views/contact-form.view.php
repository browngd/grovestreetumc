...
<!-- name --> 
 <div class="control-group<?php 
  ...
  <span class="add-on"><i class="icon-user"></i></span>
       <input class="input-xxlarge {required:true, messages:{required:'<?php _e('Please give your name.','cleanandsimple');?>'}}" type="text" id="cf-Name" name="cf-Name" value="<?php echo $contact->Name; ?>" placeholder="<?php _e('Your Name','cleanandsimple');?>">
         </div>
 ...
 <!-- message -->
  <div class="control-group<?php 
    if (isset($contact->Errors['Message'])) echo ' error'; ?>">
     ...
     <div class="controls">
       <textarea class="input-xxlarge {required:true, messages:{required:'<?php _e('Please give a message.','cleanandsimple');?>'}}" id="cf-Message" name="cf-Message" rows="10" placeholder="<?php _e('Your Message','cleanandsimple');?>"><?php echo $contact->Message; ?></textarea>
