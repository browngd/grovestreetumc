...
function bootstrap_styles()
{
	...
	wp_register_style( 'bootstrap-styles', get_template_directory_uri() . '/css/bootstrap-responsive.css', array(), '2.3.1', 'all' );
    wp_register_style( 'bootstrap', get_template_directory_uri() . '/css/bootstrap.css', array(), '2.3.1', 'all' );
